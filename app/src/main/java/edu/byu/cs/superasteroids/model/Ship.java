...
public class Ship extends MovingObject {
    ...
    public static void draw() {
        ...
        drawBody(centerX, centerY, scale, partsMap);
        drawCannon(centerX, centerY, scale, partsMap);
        drawEngine(centerX, centerY, scale, partsMap);
        drawExtra(centerX, centerY, scale, partsMap);
    ...
    public static void drawBody(int x, int y, float scale, Map<String, Integer> partsId){
        DrawingHelper.drawImage(partsId.get("body"), x, y, 0, scale, scale, 255);
    }

    public static void drawCannon(int x, int y, float scale, Map<String, Integer> partsId){
        ...
        DrawingHelper.drawImage(partsId.get("cannon"), x + xScaled, y + yScaled, 0, scale, scale, 255);
    }

    public static void drawEngine(int x, int y, float scale, Map<String, Integer> partsId){
        ...
        int yScaled = (int)(yPoint * scale);
        DrawingHelper.drawImage(partsId.get("engine"), x + xScaled, y + yScaled, 0, scale, scale, 255);
    }

    public static void drawExtra(int x, int y, float scale, Map<String, Integer> partsId){
        ...
        int yScaled = (int)(yPoint * scale);
        DrawingHelper.drawImage(partsId.get("extra"), x + xScaled, y + yScaled, 0, scale, scale, 255);
    }
